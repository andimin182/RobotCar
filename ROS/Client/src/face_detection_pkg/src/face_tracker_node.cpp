...
#include <face_detection_pkg/centroid.h>
...
class Face_Detector
{
  ...
  face_detection_pkg::centroid face_centroid;
...
public:
  ...
  haar_file_face = "/home/andi/catkin_ws/src/face_detection_pkg/src/data/face.xml";
  face_tracking = 1;
  ...
  catch(int e)
  {
    ...
    face_centroid_pub = nh_.advertise<face_detection_pkg::centroid>("/face_centroid",10);
